...
cultivos}
\author{Joshua Santeliz \\ Miguel Urbina \\ Tercer participante}
...
estas influencias. Para el profesional en Ciencias Actuariales y Ciencia
de Datos, este sector presenta un desafío fascinante: ¿Es posible
modelar la incertidumbre de las ventas globales? ¿Existen patrones
históricos estacionarios que permitan predecir el comportamiento de
...
{\centering \includegraphics[width=0.9\linewidth,]{informe_files/figure-latex/hist_dens-1} 
